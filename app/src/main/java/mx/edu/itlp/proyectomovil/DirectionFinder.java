...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyDpDUZAl4XZ_h01TRr4R0hom_yJhoPfN7w";
    ...
    private String createUrl() throws UnsupportedEncodingException{
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigen + "&destination="+urlDestino+"&key"+GOOGLE_API_KEY;
    }
